...
import { HOW_IT_WORKS_STEPS , FEATURES , SITE_STATS } from "@/lib/data";
            ...
            <div className="flex-1 text-center md:text-left">
              <Badge variant="outline"
                ...
                <p className="text-xl md:text-2xl text-stone-600 mb-10 max-w-lg mx-auto md:mx-0 font-light">
                  Snap a photo of your ingredients. We&apos;ll create delicious recipes in seconds. 
                  Cook smarter, reduce waste, and enjoy a great meal.
                </p>
                  ...
                  className="border-2 border-stone-200 bg-white hover:border-orange-600 hover:shadow-lg transition-all group py-0">
                    ...
                    <CardContent className={"p-8"}>
                      <div className="flex justify-between items-start mb-6">
                        <div className="border-2 border-stone-200 bg-orange-50 p-3 group-hover:border-orange-600 group-hover:bg-orange-100
                          transition-colors">
